defmodule Secrets do
  ...
  def secret_divide(secret), do: fn param -> trunc(param / secret) end
  ...
  def secret_combine(secret_function1, secret_function2), do: fn param -> (secret_function2.(secret_function1.(param))) end
